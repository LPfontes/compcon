  ...
  return {
      ...
      rollupOptions: {
        output: {
          manualChunks(id) {
            ...
            if (id.includes('@massif/lancer-data')) return 'lancer-data'
            if (id.includes('lancer-data-pt-br')) return 'lancer-data'
    ...
    resolve: {
      alias: [
        ...
        {
          find: '@massif/lancer-data-en',
          replacement: fileURLToPath(new URL('./node_modules/@massif/lancer-data/index.js', import.meta.url)),
        },
        {
        ...
        },
        {
          ...
          replacement: fileURLToPath(new URL('./src/lancer-data-proxy.ts', import.meta.url)),
        },
      ],
